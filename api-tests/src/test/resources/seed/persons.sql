...
INSERT INTO congressional_members (id, individual_id, bioguide_id, chamber, state, data_source, created_at, updated_at)
VALUES
    -- Senate members
    ('aaaaaaaa-1111-1111-1111-111111111111', 'aaaaaaaa-0000-1111-1111-111111111111', 'S000033', 'SENATE', 'VT', 'CONGRESS_GOV', NOW(), NOW()),
    ('bbbbbbbb-1111-1111-1111-111111111111', 'bbbbbbbb-0000-1111-1111-111111111111', 'M000355', 'SENATE', 'KY', 'CONGRESS_GOV', NOW(), NOW()),
    ('cccccccc-1111-1111-1111-111111111111', 'cccccccc-0000-1111-1111-111111111111', 'W000817', 'SENATE', 'MA', 'CONGRESS_GOV', NOW(), NOW()),
    ('dddddddd-1111-1111-1111-111111111111', 'dddddddd-0000-1111-1111-111111111111', 'C001098', 'SENATE', 'TX', 'CONGRESS_GOV', NOW(), NOW()),
    -- House members
    ('eeeeeeee-1111-1111-1111-111111111111', 'eeeeeeee-0000-1111-1111-111111111111', 'P000197', 'HOUSE', 'CA', 'CONGRESS_GOV', NOW(), NOW()),
    ('ffffffff-1111-1111-1111-111111111111', 'ffffffff-0000-1111-1111-111111111111', 'O000172', 'HOUSE', 'NY', 'CONGRESS_GOV', NOW(), NOW()),
    ('11111111-2222-1111-1111-111111111111', '11111111-0000-1111-1111-111111111111', 'J000289', 'HOUSE', 'OH', 'CONGRESS_GOV', NOW(), NOW()),
    ('22222222-2222-1111-1111-111111111111', '22222222-0000-1111-1111-111111111111', 'G000553', 'HOUSE', 'TX', 'CONGRESS_GOV', NOW(), NOW())
