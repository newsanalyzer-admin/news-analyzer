...
-- References government_organizations (must be inserted first)
...
-- GOVERNMENT_ORG entities (linked to government_organizations master data)
INSERT INTO entities (id, name, entity_type, schema_org_type, government_org_id, verified, created_at, updated_at)
VALUES
    ('11111111-2222-2222-2222-222222222222', 'Environmental Protection Agency', 'GOVERNMENT_ORG', 'GovernmentOrganization', 'dddddddd-dddd-dddd-dddd-dddddddddddd', true, NOW(), NOW()),
    ('22222222-2222-2222-2222-222222222222', 'Federal Bureau of Investigation', 'GOVERNMENT_ORG', 'GovernmentOrganization', '11111111-aaaa-aaaa-aaaa-aaaaaaaaaaaa', true, NOW(), NOW()),
    ('33333333-2222-2222-2222-222222222222', 'NASA', 'GOVERNMENT_ORG', 'GovernmentOrganization', 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', true, NOW(), NOW()),
    ('44444444-2222-2222-2222-222222222222', 'Department of Justice', 'GOVERNMENT_ORG', 'GovernmentOrganization', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', true, NOW(), NOW()),
    ('55555555-2222-2222-2222-222222222222', 'Central Intelligence Agency', 'GOVERNMENT_ORG', 'GovernmentOrganization', 'ffffffff-ffff-ffff-ffff-ffffffffffff', true, NOW(), NOW())
ON CONFLICT (id) DO NOTHING;
