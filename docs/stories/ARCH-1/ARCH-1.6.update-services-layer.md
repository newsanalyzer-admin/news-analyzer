...
- [ ] **Task 1: Create IndividualService** (AC1, AC7)
...
- [ ] **Task 2: Create CongressionalMemberService** (AC2)
...
- [ ] **Task 3: Update PresidentialSyncService** (AC3, AC7)
...
- [ ] **Task 4: Update FjcCsvImportService** (AC4, AC7)
...
- [ ] **Task 5: Update PlumCsvImportService** (AC5, AC7)
  - [ ] Replace person creation with Individual creation
  - [ ] Update deduplication logic
  - [ ] Ensure appointees get Individual records
  - [ ] Update tests

- [ ] **Task 6: Update CongressSyncService** (AC6, AC7)
...
- [ ] **Task 7: Run All Service Tests** (AC8)
  - [ ] Run full test suite
