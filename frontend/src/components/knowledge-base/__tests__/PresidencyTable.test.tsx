...
const mockPresidencies: PresidencyDTO[] = [
  {
    ...
    vicePresidents: [{ individualId: 'vp1', fullName: 'JD Vance', firstName: 'JD', lastName: 'Vance', startDate: '2025-01-20', endDate: null, termLabel: '2025-present' }],
    predecessorId: null,
    successorId: null,
    current: true,
    living: true,
  },
  {
    ...
    vicePresidents: [{ individualId: 'vp2', fullName: 'Kamala Harris', firstName: 'Kamala', lastName: 'Harris', startDate: '2021-01-20', endDate: '2025-01-20', termLabel: '2021-2025' }],
    predecessorId: null,
    successorId: null,
    current: false,
    living: true,
  },
  {
    ...
    vicePresidents: [{ individualId: 'vp3', fullName: 'John Adams', firstName: 'John', lastName: 'Adams', startDate: '1789-04-21', endDate: '1797-03-04', termLabel: '1789-1797' }],
    predecessorId: null,
    successorId: null,
    current: false,
    living: false,
